        ...
        <?php foreach ($customers as $customer) : ?>
            <tr>
                ...
                <td class="actions text-right">
                    <a href="view.php?id=<?php echo $customer['id']; ?>" class="btn btn-sm btn-secondary"><i class="fa fa-eye fa-w-18"></i> Visualizar</a>
                    <a href="edit.php?id=<?php echo $customer['id']; ?>" class="btn btn-sm btn-light"><i class="fas fa-edit fa-w-18"></i></i> Editar</a>
